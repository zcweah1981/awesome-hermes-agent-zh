...
**参考已接受项目图**：
- `assets/practical-11-discord-official-screenshot-zh-v1.png`（旧版，作为风格基线）
- `assets/practical-13-ollama-official-screenshot-zh-v1.png`
- `assets/practical-14-github-pr-review-official-screenshot-zh-v1.png`
- `assets/practical-15-skills-official-screenshot-zh-v1.png`
- `assets/practical-18-security-official-screenshot-zh-v1.png`
- `assets/practical-19-voice-mode-official-screenshot-zh-v1.png`
...
#### 1. `practical-11-discord-official-screenshot-zh-v2.png`

- **文件路径**：`assets/practical-11-discord-official-screenshot-zh-v2.png`
...
#### 2. `practical-13-ollama-official-screenshot-zh-v2.png`

- **文件路径**：`assets/practical-13-ollama-official-screenshot-zh-v2.png`
...
#### 3. `practical-14-github-pr-review-official-screenshot-zh-v2.png`

- **文件路径**：`assets/practical-14-github-pr-review-official-screenshot-zh-v2.png`
...
#### 4. `practical-15-skills-official-screenshot-zh-v2.png`

- **文件路径**：`assets/practical-15-skills-official-screenshot-zh-v2.png`
...
#### 5. `practical-16-security-official-screenshot-zh-v2.png`（原 18，重命名）

- **文件路径**：`assets/practical-16-security-official-screenshot-zh-v2.png`
...
#### 6. `practical-17-voice-mode-official-screenshot-zh-v2.png`（原 19，重命名）

- **文件路径**：`assets/practical-17-voice-mode-official-screenshot-zh-v2.png`
...
#### 7. `practical-18-hermes-advanced-official-screenshot-zh-v1.png`

- **文件路径**：`assets/practical-18-hermes-advanced-official-screenshot-zh-v1.png`
...
#### 8. `practical-19-hermes-control-room-official-screenshot-zh-v1.png`

- **文件路径**：`assets/practical-19-hermes-control-room-official-screenshot-zh-v1.png`
...
#### 9. `practical-20-60day-analyst-official-screenshot-zh-v1.png`

- **文件路径**：`assets/practical-20-60day-analyst-official-screenshot-zh-v1.png`
...
#### 10. `practical-21-hermes-ollama-fastest-official-screenshot-zh-v1.png`

- **文件路径**：`assets/practical-21-hermes-ollama-fastest-official-screenshot-zh-v1.png`
...
#### 11. `practical-22-hermes-deep-dive-official-screenshot-zh-v1.png`

- **文件路径**：`assets/practical-22-hermes-deep-dive-official-screenshot-zh-v1.png`
...
| 页面 | 图片文件名 | 状态 |
|---|---|---|
| 11-Discord | `practical-11-discord-official-screenshot-zh-v2.png` | 重做 |
| 13-Ollama | `practical-13-ollama-official-screenshot-zh-v2.png` | 重做 |
| 14-PR 审查 | `practical-14-github-pr-review-official-screenshot-zh-v2.png` | 重做 |
| 15-Skills | `practical-15-skills-official-screenshot-zh-v2.png` | 重做 |
| 16-安全加固 | `practical-16-security-official-screenshot-zh-v2.png` | 新制（原 18 文件名作废） |
| 17-语音模式 | `practical-17-voice-mode-official-screenshot-zh-v2.png` | 新制（原 19 文件名作废） |
| 18-进阶实战 | `practical-18-hermes-advanced-official-screenshot-zh-v1.png` | 首制 |
| 19-控制室 | `practical-19-hermes-control-room-official-screenshot-zh-v1.png` | 首制 |
| 20-60 天 | `practical-20-60day-analyst-official-screenshot-zh-v1.png` | 首制 |
| 21-最快路径 | `practical-21-hermes-ollama-fastest-official-screenshot-zh-v1.png` | 首制 |
| 22-深度拆解 | `practical-22-hermes-deep-dive-official-screenshot-zh-v1.png` | 首制 |
