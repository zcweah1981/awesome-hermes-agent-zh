...
如果你想继续补这块背景，可以回看：
- [SOUL.md 和 /personality](../../advanced-usage/soul-and-personality.md)
...
- [Prompt Assembly（官方）](https://hermes-agent.nousresearch.com/docs/developer-guide/prompt-assembly)
