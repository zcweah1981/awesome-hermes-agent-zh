...
<div>
  <a href="./profiles.md">多助手</a> ｜
  <a href="./memory-providers/index.md">外部记忆</a> ｜
  <a href="./context-system/index.md">上下文系统</a> ｜
  <a href="./mcp-and-plugins.md">MCP / 插件</a> ｜
  <a href="./api-server.md">API 服务</a> ｜
  <a href="./cron-and-automation.md">自动化</a> ｜
  <a href="./acp-ide.md">ACP / IDE</a>
</div>
