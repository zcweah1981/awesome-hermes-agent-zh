...
![对比图：左侧是超级个体版，一人配一个智能体快速拿到可开工包；右侧是团队协作版，多角色围绕协作文档交接与评审，最终形成团队开工包](../../assets/solution-miniapp-solo-vs-team-map-zh-v6.webp)
...
![结构图：把“你会拿到什么”拆成 3 个连续交付阶段——先定范围，再搭骨架，最后继续补全](../../assets/solution-miniapp-3-layer-map-v7.webp)
...
![对比图：左侧命令行试跑适合先快速生成并预览结果；右侧编辑器中继续适合借助智能助手持续修改文件与补全代码](../../assets/solution-miniapp-cli-vs-acp-map-zh-v10.webp)
...
### 第一步：下载它
先拿这个包：
- [packs/miniapp-lab/01-super-individual.zip](../../../packs/miniapp-lab/01-super-individual.zip)
...
![真实试跑截图：使用 miniapp-solo profile 调用 wechat-mini-program-solo-assistant 后，界面已开始输出场景、MVP 边界、页面清单和功能清单](../../assets/solution-miniapp-solo-real-run-proof.webp)
...
#### 第一步：下载团队包
先拿这个包：
- [packs/miniapp-lab/02-team.zip](../../../packs/miniapp-lab/02-team.zip)
...
![真实续跑截图：第二轮继续下指令后，miniapp-solo 已经开始实际写入 app.json、activity-list 页面文件、mock.js 和 services/activity.js](../../assets/solution-miniapp-solo-followup-proof.webp)
...
![真实协作截图：团队协作版里，product 先产出交接物，builder 再接着产出前端骨架，validator 最后给出 pass with fixes 结论](../../assets/solution-miniapp-team-handoff-proof.webp)
...
- 超级个体版下载：[packs/miniapp-lab/01-super-individual.zip](../../../packs/miniapp-lab/01-super-individual.zip)
- 团队协作版下载：[packs/miniapp-lab/02-team.zip](../../../packs/miniapp-lab/02-team.zip)
- 安装说明：[packs/miniapp-lab/INSTALL.md](../../../packs/miniapp-lab/INSTALL.md)
- 使用说明：当前页里的「⚡ 5 分钟用起来」和「🤝 团队协作版怎么安装和开跑」就是默认 doc 入口
...
- Pack 详情：[微信小程序助手 Pack](/packs/miniapp-lab)，先确认适合谁用、安装入口和下载入口。
- 原型范围还需要拆成可执行任务：继续用[行动计划助手](/docs/solutions/action-plan)整理优先级、负责人和交付顺序。
