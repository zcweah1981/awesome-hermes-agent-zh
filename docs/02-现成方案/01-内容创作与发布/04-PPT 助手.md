...
![对比图：左边是先出一版结构，强调先定叙事和页序；右边是先出逐页讲稿，强调把每页内容直接展开](../../assets/solution-ppt-structure-vs-script-v1.png)
...
![结构图：先定叙事，再拿到逐页稿，最后补图表、备注和继续落版动作](../../assets/solution-ppt-output-map-v1.png)
...
![对比图：左边是 CLI 先快速出一版 PPT 稿，右边是 ACP 进入编辑器继续精修逐页内容和表达](../../assets/solution-ppt-cli-vs-acp-v1.png)
