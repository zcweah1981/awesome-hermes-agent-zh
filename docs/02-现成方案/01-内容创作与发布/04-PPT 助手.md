...
![对比图：左边是先出一版结构，强调先定叙事和页序；右边是先出逐页讲稿，强调把每页内容直接展开](../../assets/solution-ppt-structure-vs-script-v3-cliproxy-g31.jpg)
...
![结构图：先定叙事，再拿到逐页稿，最后补图表、备注和继续落版动作](../../assets/solution-ppt-output-map-v2-cliproxy.png)
