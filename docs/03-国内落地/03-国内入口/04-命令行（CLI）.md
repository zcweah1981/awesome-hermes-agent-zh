...
- 浏览器聊天界面 → 去 [03-API 服务与 Open WebUI](./03-API 服务与 Open WebUI.md)
- 管理配置 / 会话 / 日志 → 去 [02-网页控制台（Dashboard）](./02-网页控制台（Dashboard）.md)
- 团队消息触达 → 去 [05-飞书](./05-飞书.md) / [06-企业微信（AI Bot）](./06-企业微信（AI Bot）.md) / [07-钉钉](./07-钉钉.md) / [08-个人微信](./08-个人微信.md)

但如果你要的是**先把 Hermes 本体跑顺**，先回 CLI。
...
- 如果你想开始做团队消息入口，下一步进入 [05-飞书](./05-飞书.md)
- 如果你想回到入口模块重新确认位置，回 [01-总览](./01-总览.md)
- 如果你想继续看管理台，回看 [02-网页控制台（Dashboard）](./02-网页控制台（Dashboard）.md)
- 如果你想继续看网页前端接法，回看 [03-API 服务与 Open WebUI](./03-API 服务与 Open WebUI.md)

如果你想先回到上一阶段确认前提：

- 环境还没准备好，先回 [01-国内部署 / 01-总览](../01-国内部署/01-总览.md)
- 模型路线还没决定，先回 [02-国内模型 / 01-总览](../02-国内模型/01-总览.md)
