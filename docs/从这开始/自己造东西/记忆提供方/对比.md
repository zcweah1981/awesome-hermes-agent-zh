...
| 看哪一页 | [Holographic](./全息记忆.md) | [Honcho](./Honcho记忆.md) | 先回看 [外部记忆总览](./index.md) / [持久记忆](../../玩出花样/持久记忆.md) / [Profiles](../多助手.md) |
...
如果你已经在认真使用 [Profiles](../多助手.md)，或者已经明确自己要的是多助手长期协作，Honcho 比 Holographic 更对题。
...
- 想先把内建记忆和边界搞扎实 → [持久记忆](../../玩出花样/持久记忆.md)
- 想先把多个助手的分工方式理顺 → [Profiles](../多助手.md)
- 想退回“自己造东西”这一层 → [自己造东西](../总览.md)
