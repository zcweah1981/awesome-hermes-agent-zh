...
![从 OpenClaw 到 Hermes 的迁移步骤图：先盘点资产、提炼角色、拆出技能、接模型与入口，再用一个最小稳定案例完成验证。](./assets/openclaw-hermes-migration-flow-v1.png)
...
![OpenClaw 资产如何 Hermes 化：把临时 prompt、agent 人设、成功输出、失败复盘和重复步骤，重构成 Hermes 的角色、skills、模板、案例与长期记忆。](./assets/openclaw-hermes-asset-map-v1.png)
...
![迁移后的建议目录结构：全局人格放在 HERMES_HOME，稳定能力进入 skills，按职责拆开的助手进入 profiles。](./assets/openclaw-hermes-migration-directory-v1.png)
