...
![Hermes Agent 语音模式三大入口架构：CLI Ctrl+B 本地录音、Telegram 语音消息上传、Discord 语音频道加入；统一经 STT（faster-whisper）转文字 → Agent Loop → TTS（Edge TTS / OpenAI）转语音回应](../../assets/practical-v2-11-voice-mode.png)
