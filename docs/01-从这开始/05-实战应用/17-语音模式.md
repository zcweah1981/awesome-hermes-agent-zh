...
> 一句话先说清楚：这一页教你打开 Hermes 的"嘴和耳朵"——CLI 里按 Ctrl+B 就能跟它说话、Telegram 里发语音消息它能听懂、Discord 里它能加进语音频道跟你群聊。三种入口，一套 STT/TTS 引擎。语音只是入口变化，Agent 内核不变；如果你想理解内核怎么工作，可以配合“22-Hermes Agent 深度拆解与自建指南”一起看。

![语音模式 总览图](../../assets/practical-v2-17-voice-mode-00-overview-cn.webp)
...
![语音模式 实操流程图](../../assets/practical-v2-17-voice-mode-01-workflow-cn.webp)
