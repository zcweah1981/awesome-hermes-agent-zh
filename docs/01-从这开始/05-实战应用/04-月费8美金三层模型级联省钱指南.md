...
![Hermes 三层模型级联总览：Default、Medium、Heavy 三档按任务复杂度路由，把月费控制在约 8 美金](../../assets/practical-v2-04-model-cascade-saving-00-routing-overview.webp)
...
![Hermes 模型级联成本看板：通过预算护栏、任务分布和路由规则控制模型调用费用](../../assets/practical-v2-04-model-cascade-saving-01-cost-dashboard.webp)
