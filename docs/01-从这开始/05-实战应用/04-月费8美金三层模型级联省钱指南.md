...
来源：[官方文档 — Configuring Models](https://hermes-agent.nousresearch.com/docs/user-guide/configuration/configuring-models)；社区推文 [x.com/Lonely__MH — auxiliary 配置实测](https://x.com/Lonely__MH)。
...
来源：[本文 + 官方 Configuring Models](https://hermes-agent.nousresearch.com/docs/user-guide/configuration/configuring-models)。
