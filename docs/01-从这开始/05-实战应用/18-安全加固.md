# 🔒 18-安全加固：给你的 AI Agent 划好安全红线

> 一句话先说清楚：Hermes 是一个能跑 shell 命令、能写文件、能花你钱的 AI Agent。不加固就上线，等于把 root 钥匙交给一个刚认识一天的新同事。这一页讲清楚四道必装的红线，从"准入"到"命令审批"到"容器隔离"到"密钥保护"，让你既能享受 Agent 的能力，又不至于半夜被 Telegram 推送叫醒。

![Hermes 安全加固四层：用户白名单 → 命令审批 → 容器隔离 → 密钥保护，缺一不可](../../assets/practical-18-security-official-screenshot-zh-v1.png)
...
完成后进入：
[19-语音模式：让 Hermes 听懂你说的话、开口回答你](<./19-语音模式.md>)
...
- GitHub Developer 文档 — [Fine-grained PAT](https://docs.github.com/en/authentication/keeping-your-account-and-data-secure/managing-access-tokens)
