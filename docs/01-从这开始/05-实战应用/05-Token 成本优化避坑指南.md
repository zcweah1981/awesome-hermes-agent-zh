...
![Hermes Token 成本构成图：工具定义、系统 Prompt、记忆、Skill 和对话上下文共同组成每轮固定成本](../../assets/practical-v2-05-token-cost-00-token-stack-cn.webp)
...
- 回到[实战应用总览](/docs/start/practical)，根据当前成本瓶颈选择模型路由、自托管或自动化路径。
