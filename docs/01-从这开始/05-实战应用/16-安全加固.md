...
![安全加固 总览图](../../assets/practical-v2-16-security-hardening-00-overview-cn.webp)
...
![安全加固 实操流程图](../../assets/practical-v2-16-security-hardening-01-workflow-cn.webp)
...
- 回到[实战应用总览](/docs/start/practical)，在继续部署、自动化或多入口接入前复核相应安全边界。
