...
4. 后面的[记忆](./03-让 Hermes 记住你.md)、[模型](./04-自定义 AI 大模型.md)、[工具](./05-让工具更顺手.md)配置，都会更容易分层，不会混成一锅
...
- 某次任务的临时要求
- API key、路径、账号、隐私数据
- [模型](./04-自定义 AI 大模型.md)、[工具](./05-让工具更顺手.md)、[MCP](../04-自己造东西/05-把 Hermes 接进外部系统.md)、插件之类配置细节
- 试图用奇怪元指令“黑”系统提示
...
- 想改长期默认风格，改 `SOUL.md`
- 想临时试一种说话方式，用[/personality](../02-开始上手/03-常用斜杠命令与会话管理.md)
- 想告诉 Hermes 这个仓库怎么做事，用[AGENTS.md](../04-自己造东西/04-上下文系统/02-上下文文件.md)
