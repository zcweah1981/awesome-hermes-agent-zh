...
如果你现在还没把任何模型接通，先回到：
- [05-配好 AI 大模型并完成第一次互动](<../01-先跑起来/05-配好 AI 大模型并完成第一次互动.md>)
...
1. 你是不是还没完成最基础的模型接通
   - 先回 [05-配好 AI 大模型并完成第一次互动](<../01-先跑起来/05-配好 AI 大模型并完成第一次互动.md>)
...
- [03-模型 Provider 与自定义 endpoint 问题](../../05-遇到问题/03-模型%20Provider%20与自定义%20endpoint%20问题.md)
