...
如果你对内建记忆还不够熟，先回看：[让 Hermes 记住你：持久记忆只看 USER.md 和 MEMORY.md](../../03-玩出花样/02-让Hermes记住你.md)
...
- 你连内建 [持久记忆](../../03-玩出花样/02-让Hermes记住你.md) 还没用顺
- 你当前真正需要的是多助手 / 多 profile 共享与建模，而不是先接一个本地外部 fact store
- 你现在的问题其实是助手角色混乱，更应该先看 [01-多个助手一起工作](../01-多个助手一起工作.md)
...
完成后进入：
- [02-Honcho记忆](02-Honcho记忆.md)

如果你想先回到上一阶段入口重新确认位置：
- [02-接入外部记忆系统](01-总览.md)
