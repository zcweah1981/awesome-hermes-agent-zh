...
如果你现在还没把内建记忆用顺，先回看：[持久记忆](../../03-玩出花样/02-让Hermes记住你.md)。
...
- 你已经在认真使用 [01-多个助手一起工作](../01-多个助手一起工作.md)
...
如果你只是想先跑通第一条最短外部记忆路线，去看 [Holographic](./01-Holographic记忆.md)。
如果你还在比较路线，先看 [外部记忆对比](./03-外部记忆对比.md)。
