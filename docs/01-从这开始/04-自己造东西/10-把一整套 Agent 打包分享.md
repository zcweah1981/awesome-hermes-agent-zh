...
![Profile Distribution 结构图：本地 Profile 整理成不含密钥和私有数据的 Git 分发仓库，经 hermes profile install 安装后生成用户自己的 Profile](../../assets/rm2-4-profile-distribution-structure-v1.webp)
