...
这一页只解决一件事：
不讲安装，不讲配置，只帮你判断现在该先走 [Holographic](./02-全息记忆.md)、先走 [Honcho](./03-Honcho记忆.md)，还是先不要装外部 provider。
...
| 看哪一页 | [Holographic](./02-全息记忆.md) | [Honcho](./03-Honcho记忆.md) | 先回看 [外部记忆总览](./01-总览.md) / [持久记忆](../../03-玩出花样/03-持久记忆.md) / [Profiles](../02-多助手.md) |
...
如果你已经在认真使用 [Profiles](../02-多助手.md)，或者已经明确自己要的是多助手长期协作，Honcho 比 Holographic 更对题。
...
- 想先把第一条外部记忆路线跑通 → 去 [Holographic](./02-全息记忆.md)
- 想先把多助手共享记忆结构搭起来 → 去 [Honcho](./03-Honcho记忆.md)
- 还说不清 → 先停在这一页，不要急着装
...
- 想先跑通第一条外部记忆路线 → [Holographic](./02-全息记忆.md)
- 想先搭多助手共享记忆结构 → [Honcho](./03-Honcho记忆.md)
- 想回到这一层重新确认边界 → [外部记忆总览](./01-总览.md)
- 想先把内建记忆和边界搞扎实 → [持久记忆](../../03-玩出花样/03-持久记忆.md)
- 想先把多个助手的分工方式理顺 → [Profiles](../02-多助手.md)
- 想退回“自己造东西”这一层 → [04-自己造东西](../01-总览.md)
