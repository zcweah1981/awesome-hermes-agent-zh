...
这一页只解决一件事：
不讲安装，不讲配置，只帮你判断现在该先走 [Holographic](./全息记忆.md)、先走 [Honcho](./Honcho记忆.md)，还是先不要装外部 provider。
...
| 看哪一页 | [Holographic](./全息记忆.md) | [Honcho](./Honcho记忆.md) | 先回看 [外部记忆总览](./01-总览.md) / [持久记忆](../../03-玩出花样/03-持久记忆.md) / [Profiles](../02-多助手.md) |
...
- 想先把第一条外部记忆路线跑通 → 去 [Holographic](./全息记忆.md)
- 想先把多助手共享记忆结构搭起来 → 去 [Honcho](./Honcho记忆.md)
- 还说不清 → 先停在这一页，不要急着装
